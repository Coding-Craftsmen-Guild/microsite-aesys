...
namespace Aesys.Core.Models
{
	...
	public partial class ContactForm : PublishedElementModel, IIntroText
	{
		// helpers
...
#pragma warning restore 0109
		...
		///<summary>
		/// Form Subtitle: Short copy under the form heading (e.g. response-time note). Plain text.
		///</summary>
		[global::System.CodeDom.Compiler.GeneratedCodeAttribute("Umbraco.ModelsBuilder.Embedded", "17.4.2+b87d519")]
		...
		///<summary>
		/// Form Title: Heading shown above the form fields (right column). Distinct from the Intro Text title on the left.
		///</summary>
		[global::System.CodeDom.Compiler.GeneratedCodeAttribute("Umbraco.ModelsBuilder.Embedded", "17.4.2+b87d519")]
		[global::System.Diagnostics.CodeAnalysis.MaybeNull]
		...
		///<summary>
		/// Recipients: Email address(es) that submissions are sent to. Separate multiple addresses with a comma or semicolon.
		///</summary>
		[global::System.CodeDom.Compiler.GeneratedCodeAttribute("Umbraco.ModelsBuilder.Embedded", "17.4.2+b87d519")]
		[global::System.Diagnostics.CodeAnalysis.MaybeNull]
		[ImplementPropertyType("recipients")]
		public virtual string Recipients => this.Value<string>(_publishedValueFallback, "recipients");
